package kr.co.corrigo.smartwalker.blog;
 ...
 */
public class BlogFragment extends Fragment implements MainActivity.OnBackPressedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.i("BlogFragOnCreate", "width = " + mWebView.getWidth() + "height =" + mWebView.getHeight());
        ...
        if(mWebView.getUrl() == null) {
            ...
            mWebView.loadUrl("http://corrigo100.cafe24.com/bbs/board.php?bo_table=gallery");
        }
